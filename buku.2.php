<div class="products">  
<h2>Daftar Buku Katagori Mesin</h2>
<?php
include"koneksi.php";
...
$query="SELECT * FROM buku where kdKategori='2' order by kdBuku desc LIMIT $offset, $totaldata";
$result=mysql_query($query) or die('Error');
$query="SELECT COUNT(*) AS jumData FROM buku kdKategori='2'";
